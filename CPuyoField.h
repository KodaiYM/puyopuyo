...
public:
	...
	CPuyoField(int row, int col, int puyo_size);
...
private:
	const std::shared_ptr<IGraphic> m_left_cross;
	const std::shared_ptr<IGraphic> m_right_cross;
	...
	int subCountConnection(int i, int j, PuyoType type,
